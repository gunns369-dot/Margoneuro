...
(async function() {
    ...
    function margoneuroGetLicenseKey() {
        ...
        const enteredKey = window.prompt('Wprowadź klucz licencyjny Margoneuro:');
    ...
    async function margoneuroVerifyLicenseBeforeStart() {
        ...
        const licenseKey = margoneuroGetLicenseKey();
        ...
        try {
            const result = await margoneuroPostJson(
            ...
            if (!result.ok || !result.data || result.data.active !== true) {
                ...
                window.alert(result.data?.message || 'Licencja nieprawidłowa. Margoneuro nie zostanie uruchomione.');
                return false;
            }
            ...
            console.warn('[Margoneuro License] Licencja odrzucona', error);
            window.alert('Nie udało się zweryfikować licencji. Margoneuro nie zostanie uruchomione.');
            return false;
        }
    }
